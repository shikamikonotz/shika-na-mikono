...
\subsection{Activity: Solar System Mobile}
\begin{itemize}
...
\subsection{Activity: Star Gazing}
\begin{itemize}
...
subsection{Activity: Water Weight and Upthrust}
\begin{itemize}
...
subsection{Activity: Pencil Launcher}
\begin{itemize}
...
\subsection{Activity: Conductor Switch Test}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\subsection{Activity: Light Bulb in a Jar}
\begin{itemize}
...
\subsection{Activity: U-Tube apparatus}
\begin{itemize}
...
Measure the relative heights of water and the kerosene from the bottom level of the kerosene. The heights are related to the densities by:
	Height of water  height of kerosene = density of kerosene  density of water}
...
\subsection{Activity: Simple Motor}
\begin{itemize}
...
\subsection{Activity: Creating a Current in a Wire}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\subsection{Activity: Mapping Induced Magnetic Field from a Coil}
\begin{itemize}
\item{Preparation Time: 15 minutes}
...
\subsection{Activity: Mapping Induced Magnetic Field from Wire}
\begin{itemize}
...
\subsection{Activity: Spinning Compass}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Water Pour}
\begin{itemize}
...
\subsection{Activity: Paper Blow}
\begin{itemize}
\item{Preparation time: none}
...
\subsection{Activity: Spring pull}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Pinhole Camera}
\begin{itemize}
\item{Preparation Time: half hour}
...
\subsection{Activity: Light through a Comb}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Kaleidoscope}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\subsection{Activity: Color wheel}
\begin{itemize}
\item{Preparation time: Half hour}
...
\subsection{Activity: Thin Film Interference}
\begin{itemize}
\item{Preparation time: 5 minutes}
...
\subsection{Activity: Water Prism}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Refraction of light through water}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\subsection{Activity: Rectangular Prism}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Pouring light}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\section{Lenses}
subsection{Activity: Focusing an Image through a Convex Lens}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Measurement Errors}
\begin{itemize}
\item{Preparation time: 1 minute}
...
\subsection{Activity: Beam balance}
\begin{itemize}
\item{Preparation Time: half hour}
...
\subsection{Activity: Spring balance}
\begin{itemize}
\item{Preparation time: 1 hour}
...
\subsection{Activity: Suspended Magnet Compass}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Magnetic Dip Gauge}
\begin{itemize}
\item{Preparation Time: 15 minutes}
...
\subsection{Activity: Mapping Magnetic Fields}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Pin compass}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Magnetizing a Nail}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Tin Can Piñata}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\subsection{Activity: Magic Card Trick}
\begin{itemize}
\item{Preparation Time: none}
...
\subsection{Activity: Balloon Rocket}
\begin{itemize}
...
\subsection{Activity: Bottle Rocket}
\begin{itemize}
\item{Preparation Time: 1 hour}
...
\subsection{Activity: Matchstick Rocket}
\begin{itemize}
\item{Preparation time: 5 minutes}
...
\subsection{Activity: Object Toss}
\begin{itemize}
\item{Preparation time: none}
...
\subsection{Activity: Hydraulic Press}
\begin{itemize}
\item{Preparation Time: 15 minutes}
...
\subsection{Activity: Holey Bottle #1}
\begin{itemize}
\item{Preparation time: 5 minutes}
...
\subsection{Activity: Holey Bottle #2}
\begin{itemize}
\item{Preparation Time: 10 minutes}
...
\subsection{Activity: Straw Fountain}
\begin{itemize}
\item{Preparation Time: 10 minutes}
...
\subsection{Activity: Balloon Pop}
\begin{itemize}
...
\subsection{Activity: Potato Poke}
\begin{itemize}
\item{Preparation Time: none}
...
\subsection{Activity: Straw Elevator}
\begin{itemize}
\item{Preparation Time: none}
...
\subsection{Activity: Reverse Air Pump}
\begin{itemize}
...
\subsection{Activity: Atmospheric Pressure}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\subsection{Activity: Water drops}
\begin{itemize}
\item{Preparation time: none}
...
\subsection{Activity: Blowing bubbles}
\begin{itemize}
\item{Preparation time: 5 minutes}
...
\subsection{Activity: Pepper Float}
\begin{itemize}
\item{Preparation time: none}
...
\subsection{Activity: Water Dome}
...
\subsection{Activity: Pinching Water}
\begin{itemize}
\item{Preparation Time: 10 minutes}
...
\section{Rotation}
subsection{Activity: Object Spin}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Twenty Shillings of Equilibrium}
\begin{itemize}
\item{Preparation Time: none}
...
\subsection{Activity: Helicopters}
\begin{itemize}
\item{Preparation Time: 15 minutes}
...
\subsection{Activity: Door Tug-o-War}
\begin{itemize}
\item{Preparation time: none}
...
\subsection{Activity: Spinning Eggs}
\begin{itemize}
\item{Preparation time: none}
...
\subsection{Activity: Race of Rigid Bodies}
\begin{itemize}
\item{Preparation time: 5 minutes}
...
\subsection{Activity: Simple Oscillator}
\begin{itemize}
\item{Preparation time: 1 minute}
...
\subsection{Activity: Bottle Sine Graph}
\begin{itemize}
\item{Preparation time: 5 minutes}
...
\subsection{Activity: Barton’s Pendulums}
\begin{itemize}
\item{Preparation time: 5 minutes}
...
\subsection{Activity: Sound in a Medium}
\begin{itemize}
\item{Preparation Time: half hour}
...
\subsection{Activity: Spoon bell}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: One-String Guitar}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\subsection{Activity: Bottle Amplifier}
\begin{itemize}
\item{Preparation Time: 10 minutes}
...
\subsection{Activity: Transverse Waves on a String}
\begin{itemize}
...
\subsection{Activity: Musical rubber strip}
\begin{itemize}
\item{Preparation time: none}
...
\subsection{Activity: Musical Soda Bottle}
\begin{itemize}
\item{Preparation time: none}
...
\subsection{Activity: Doppler Whirl}
\begin{itemize}
\item{Preparation time: 5 minutes}
...
\subsection{Activity: Circuit Board}
\begin{itemize}
\item{Preparation Time: 1 hour}
...
\subsection{Activity: Breadboards}
\begin{itemize}
...
\subsection{Activity: Bottle Cap Gearworks}
\begin{itemize}
\item{Preparation Time: 30 minutes}
...
\subsection{Activity: Pulleys and Inclined Planes}
\begin{itemize}
\item{Preparation Time: 15 minutes}
...
\subsection{Activity: Salt and Pepper Trick}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Electrostatics}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\subsection{Activity: Copper Coil Candle Snuffer}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\subsection{Activity: Conduction of heat by different materials}
\begin{itemize}
...
\subsection{Activity: Hot Water Hold}
\begin{itemize}
\item{Preparation time: 10 minutes}
...
\subsection{Activity: Thermal Windmills}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Sawdust Water Currents}
\begin{itemize}
\item{Preparation Time: 1 minute}
...
\subsection{Activity: Specific Heats}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\item{Theory: Specific heat capacity is given by where H is the heat needed to raise a mass m a temperature. Since the liquid and water are being mixed, the same amount of energy used to raise the liquid’s temperature is lost by the water to cool it down. We can set the heat of water Hw equal to the heat of the liquid Hl. The masses of the substances are known (by using the mole equations), and you measured the changes in temperature with the thermometer. The specific heat capacity of water is 4200 J/kgK, so you can solve for the specific heat capacity of the liquid.}
\end{itemize}

\subsection{Activity: Expansion of Liquids: Moving Colors}
\begin{itemize}
\item{Preparation Time: 15 minutes}
...
\subsection{Activity: Expansion of Gases: Oil Elevator}
\begin{itemize}
\item{Preparation Time: 15 minutes}
...
\subsection{Activity: Expansion of Solids: Screw and Loop}
\begin{itemize}
\item{Preparation Time: 5 minutes}
...
\subsection{Activity: Conical Pendulum}
\begin{itemize}
\item{Preparation time: 1 minute}
...
\subsection{Activity: Bicycle Turn}
\begin{itemize}
\item{Preparation time: none}
...
\subsection{Activity: Ripple tank}
\begin{itemize}
...
\subsection{Activity: String Waves}
\begin{itemize}
\item{Preparation time: none}
...
\subsection{Activity: Work as Heat, Part A}
\begin{itemize}
\item{Preparation time: 5 minutes}
...
\subsection{Activity: Work as Heat, Part B}
\begin{itemize}
\item{Preparation time: 0 minutes}
...
\subsection{Activity: Work as Light}
\begin{itemize}
\item{Preparation time: 0 minutes}
