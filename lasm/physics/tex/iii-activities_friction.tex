...
Friction is the force which opposes motion.  When two bodies in contace are moving against each other, there is opposition to the motion.  Friction between two surfaces depends on the nature of the surfaces in contact.
