...
\ce{2H2O2} $\longrightarrow$ \ce{2H2O} + \ce{O2}
...
\ce{CO2}$_{(g)}$   + \ce{Ca(OH)2}$_{(aq)}$ $\longrightarrow$ \ce{CaCO3}$_{(s)}$   +   \ce{H2O}$_{(l)}$
Passing excess carbon dioxide the milky colour disappears due to formation calcium hydrogen carbonate which is soluble.
\ce{CaCO3}$_{(s)}$   +   \ce{H2O}$_{(l)}$   +   \ce{CO2}$_{(g)}$ $\longrightarrow$ \ce{Ca(HCO3)2} $_{(aq)}$
...
Mg$_{(s)}$  + \ce{CO2}$_{(g)}$  $\longrightarrow$ \ce{MgO} $_{(s)}$    +   C$_{(s)}$
