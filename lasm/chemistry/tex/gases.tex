...
Oxygen is a colourless, ordourless, reactive gas essential for aerobic respiration. 20\% of the air is oxygen. Oxygen is most easily prepared by the catalytic decomposition of hydrogen peroxide. Oxygen supports combustion and will re-light a glowing splint. Oxygen also reacts vigorously with both metals and non-metals.
...
6 percent hydrogen peroxide*, manganese (IV) oxide*, water, sulphur powder*, gas generator*, spoon*, match box, thin dry stick, deflagrating spoon*, beaker*
...
\begin{enumerate}
\item{Take the bottle of from the sulphur test outside and away from people. Open the bottle and leave it with the open end pointing down. After one hour or longer, dispose of the bottle as with other plastic trash.}
...
\ce{2NaOH}$_{(aq)}$+\ce{CO2}$_{(g)}$ $\longrightarrow$ \ce{Na2CO3}$_{(aq)}$ + \ce{H2O}$_{(l)}$
Concentrated \ce{H2SO4} is a good drying agent for gases. It absorbs the atmospheric water vapour.
Heated copper absorbs the atmospheric oxygen to become copper oxide.
\ce{2Cu}$_{(s)}$ + \ce{O2}$_{(g)}$ $\longrightarrow$ \ce{2CuO}$_{(s)}$
...
\subsubsection*{Results and Conclusion}
The greenish-yellow colour of chlorine should be clearly visible, especially against a white backgrouns. The chlorine gas will bleach the flowers in the bottle. The bleaching action is due to the formation of hypochlorite ion, formed when chlorine dissolves in water:
...
Ammonia is a colourless gas with a sharp, choaking smell like that of old urine. The gas is reactive and harmful to inhale. Ammonia is highly soluble in water in which it forms basic solution of ammonium hydroxide.
