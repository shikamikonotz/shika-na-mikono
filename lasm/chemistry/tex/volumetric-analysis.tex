...
introduction
theory
terminology (apparatus)
indicators: local and commercial
preparation of solutions
calculating the amount needed
water: measurement and type
preparing crude solutions from liquids
preparing crude solutions from solids
relative standardization
simple acid-base titration
percent purity (wrt relst)
relative atomic mass (wrt relst)
water of crystalization (wrt relst)

materials: burette*, pipette*, dropper*, beakers*
...
\subusection{Procedure for Relative Standardization}
...
There are three volumetic analysis activities commonly found on national examinations: determining the percent purity of a substance, determining relative molecular mass, and determining water of crystalization. Each of these activities uses the simple acid-base titration procedure above. The differences are in the preparation for the teacher and the calculations for the student.

\subsection{Determining Percent Purity}

Volumetric analysis may be used to find the purity of an acid or a base. 

\subsubsection{Preparation Procedure}

\subsubsection{Activity Procedure}

use the provided solutions to perform SABT
use the result to calculate the percent purity:

\%P = measured molarity / given molarity

\subsection{Determining Relative Atomic Mass}

Volumetric analysis may also be used to determine the ...

\subsubsection{Activity Procedure}

use the provided solutions to perform SABT
use the result to calculate the atomic mass:

??NaOH / MOH = measured molarity / given molarity

\subsection{Determining Water of Crystalization}

Many salts crystalize together with a predictable number of water molecules trapped in the crystal. For example, sodium carbonate usually forms a decahydrate, Na2CO3*10H2O, where the crystals have ten molecules of water for every molecule of Na2CO3. The pourpose of this activity is to determine the water of crystalization of a compound.
...
use the provided solutions to perform SABT
use the result to calculate the water of crystalization:

MW compound / MW compound + n18 = measured / given
