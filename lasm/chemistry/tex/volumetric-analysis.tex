...
Many salts crystallize together with a predictable number of water molecules trapped in the crystal. For example, sodium carbonate usually forms a decahydrate, \ce{Na2CO3}*10\ce{H2O}, where the crystals have ten molecules of water for every molecule of \ce{Na2CO3}. The purpose of this activity is to determine number of waters of crystallization for the given compound.
