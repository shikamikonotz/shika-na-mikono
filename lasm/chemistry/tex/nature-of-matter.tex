...
\item{Leave the mixture for some time and observe any colour changes from the initial liquids. Allow the mixture to settle and run off the lower layer of water into a clean beaker.}
\item{Collect the kerosene in 
\end{enumerate}
