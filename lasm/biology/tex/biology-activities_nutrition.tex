...
\begin{enumerate}
\item{Mix about 10 mL (one capfull) of cooking oil and about 100 ml of water in a plastic bottle.}
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{Students will be able to carry out test for proteins in a given food sample.}
\end{itemize}
...
\item{What is purpose of this nutrient in the human body?}
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{Students will be able to carry out test for starch in a given food sample.}
\end{itemize}
...
\subsubsection*{Preparation Procedure}
\begin{enumerate}
\item{Prepare a food sample solution by either saving the water that remains from boiling pasta or potatoes, or by mixing 2 teaspoons of maize flour into about a litre of water.}
\end{enumerate}
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{Students will be able to carry out food tests for reducing sugar in a given food sample.}
\end{itemize}
...
\subsubsection*{Preparation Procedure}
\begin{enumerate}
\item{Make a solution of a food sample containing a reducing sugar. This can be done by adding a spoonful of glucose to a litre of water or cutting an onion into quarters, grinding them in a mortar and pestle, and collecting and diluting the juice.}
\end{enumerate}
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{Students will be able to carry out food test for non-reducing sugar in a given food sample.}
\end{itemize}
...
\subsubsection*{Results and Conclusion}
The colour of the food sample will change from green to yellow to a brick red precipitate. This indicates the presence of a non-reducing sugar.
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{Students will be able to describe the different structures in a leaf and their roles in photosynthesis.}
\end{itemize}
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{Students will be able to show that starch is a product of photosynthesis.}
\end{itemize}
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{Students will be able to show that carbon dioxide is necessary for photosynthesis.}
\end{itemize}
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{Students will be able to demonstrate the importance of chlorophyll in photosynthesis.}
\end{itemize}
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{Students will be able to show that light is needed for photosynthesis.}
\end{itemize}
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{Students will be able to demonstrate that oxygen is a byproduct of photosynthesis.}
\end{itemize}
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{Students will be able to investigate the roles of essential mineral elements in plant nutrition.}
\item{Students will be able to identify different mineral deficiencies in plants.}
\end{itemize}
